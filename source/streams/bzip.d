...
class BzipException : Exception
{
    @safe this(int err, in string file = __FILE__, size_t line = __LINE__, Throwable next = null) pure nothrow
    {
        ...
        case BZ_MEM_ERROR:
            ...
            break;
        case BZ_DATA_ERROR:
            msg = "Data integrity error detected in the compressed stream";
            break;
        case BZ_DATA_ERROR_MAGIC:
            msg = "Compressed stream doesn't begin with the right magic bytes";
            break;
        case BZ_CONFIG_ERROR:
            msg = "The library has been mis-compiled";
            break;
        default:
